...
import Alien1 from '../../images/Alien-isolated-on-transparent-background-PNG.png'
...
export const EmptyList = ({ type }) => {
  const text = type === 'orders' ? 'Your orders list is empty.' : 'Your favorite list is empty';
  return (<>
